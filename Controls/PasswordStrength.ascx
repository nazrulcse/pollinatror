...
<!--Reference: http://jsfiddle.net/dimitar/n8Dza/ -->
<style type="text/css">
div.pass-container {
    height: 30px;
    display: none;
...
<script type='text/javascript'>//<![CDATA[ 
    window.addEvent('load', function () {
        ...
        */
                ...
                runPassword: function (event, password) {
                    ...
                    if (o.render) {
                        if (password.length > 0) {
                            ...
                            this.stbox.style.display = 'block';
        ...
        $('input.password-strength-meter:password').each(function () {
            var passwordChecker = new StrongPass($(this).attr('id'), {
                render: true,
