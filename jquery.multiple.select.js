...
(function($) {
    ...
    function MultipleSelect($el, options) {
        ...
        if (this.$el.attr("position") != "") options.position = this.$el.attr("position");
    ...
    MultipleSelect.prototype = {
        ...
        optionToHtml: function(i, elm, group, groupDisabled) {
            ...
            if ($elm.is('option')) {
                var value = $elm.val(),
                    ...
                    icon = this.options.iconer(value) ? '<img width="18" height="18" src="' + this.options.iconer(value) + '" />' : '';
        ...
        update: function(isInit) {
            ...
            if (selects.length === 0) {
                ...
                {
                    $span.addClass('placeholder').html(this.$el.attr("placeholder"));
                } else {
