     ...
     <div class="fileupload-content" style="padding-top:10px; padding-bottom:15px">
         ...
         <div>
             <div style="float: left;"><span class="circle">OR</span></div>
              <div style="float: left; padding-top: 6px; font-size: 11px; font-weight: bold">Paste an image URL here</div>
            ...
            <div style="clear:both;margin-left: 204px;">
        ...
        <td class="delete">
            <button data-type="${delete_type}" data-url="${delete_url}">Delete</button>
             <div style="margin-top:-35px;margin-left:35px">
                      <img id="deletingImg" src="loading.gif" style="display:none"  >
              </div>
        </td>
    </tr>
</script>
...
<script>
    ...
    .bind('fileuploadadd', function (e, data) {
        var lastFile = $('#fileupload').find('.files tr:last').get(0);
        if (lastFile)
            lastFile.scrollIntoView();
    })
    .bind('fileuploaddestroy', function (e, data) {
        $(data.context[0]).find("#deletingImg").css("display", "inline");

        var deleteUrl = data.url;
        $('#fileupload').find("#deletingUrl").val($('#fileupload').find("#deletingUrl").val() + deleteUrl + ";");
    })
    .bind('fileuploaddestroyed', function (e, data) {
        $(data.context[0]).find("#deletingImg").css("display", "none");
